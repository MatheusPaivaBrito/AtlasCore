...
class EventingSettings(BaseSettings):
    ...
    # CORS
    # ------------------------------------
    CORS_ENABLED: bool = Field(default=True, validation_alias=AliasChoices("EVENTING_API_CORS_ENABLED", "CORS_ENABLED"))
    CORS_ALLOWED_ORIGINS_RAW: str = Field(
        default="",
        validation_alias=AliasChoices("EVENTING_API_CORS_ALLOWED_ORIGINS", "CORS_ALLOWED_ORIGINS"),
    )
    CORS_ALLOW_CREDENTIALS: bool = Field(
        default=True,
        validation_alias=AliasChoices("EVENTING_API_CORS_ALLOW_CREDENTIALS", "CORS_ALLOW_CREDENTIALS"),
    )
