# Core/Notification Slack Delivery Contract

## Summary

`core_api` requests `notification_api` to accept a Slack message delivery.

This contract is used for operational messages that originate from product-domain workflows.
